        ...
        <div className="container">
            ...
            <Form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Control type="text" className={errors.categoria && "is-invalid"} {...register("categoria", { required: "A categoria é obrigatória.", maxLength: { value: 100, message: "Limite de 100 caracteres."} })} />
